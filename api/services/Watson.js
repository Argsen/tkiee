...
var Watson = module.exports = function(options) {
...
Watson.prototype.speechToTextCustom = function(speechFile, grammarFile, reqParams, callback) {
    ...
    var reqHeaders = {
        ...
        'X-SpeechContext': 'GenericHints'			// Possible Values: GenericHints, GrammarList
    };
    ...
    var request_details = {
        ...
        multipart: [
//            {
//                'Content-Disposition': 'form-data; name="x-dictionary"; filename="example.pls"',
//                'Content-Type': 'application/pls+xml',
//                body: fs.readFileSync( '/home/ken/Desktop/ppt and txt/english-dictionary.xml', { encoding: 'utf8' } )
//            },
            {
...
//                body: fs.readFileSync( grammarFile, { encoding: 'utf8' } )
            ...
            },
            {
                ...
                'Content-Type': reqParams["Content-Type"] || 'audio/wav',
