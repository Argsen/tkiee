...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Drag &amp; Drop Files(.ppt/.pptx/.doc/.docx/.xls/.xlsx/.pdf)</b></span>",
            abortStr: "Abort",
			loading: "Loading",
            cancelStr: "Cancel",
            deletelStr: "Delete",
        ...
        function createProgressDiv(obj, s) {
			...
			this.loading = $("<div class='ajax-file-upload-loading'>" + s.loading + "</div>").appendTo(this.statusbar).hide();
        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj) {
            ...
            var options = {
                ...
                success: function (data, message, xhr) {
                    if (data.indexOf("ok") > -1 || data.indexOf("success") > -1) {
                        ...
                        pd.progressDiv.hide();
                        pd.statusbar.append("<span style='color:red;'>ERROR: " + data + "</span>");
                        pd.loading.hide();
                    }
                },
