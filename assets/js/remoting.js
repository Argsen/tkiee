...
JsMain.main = function() {
	...
	JsMain.cnx = haxe.remoting.ExternalConnection.flashConnect("default","recorderObject",ctx);
}
JsMain.changePage = function(page, pre) {
	JsMain.cnx.resolve("Recorder").resolve("changePage").call([page, pre]);
}
JsMain.setKeyPhase = function(key) {
	JsMain.cnx.resolve("Recorder").resolve("setKeyPhase").call([key]);
}
JsMain.start = function(page, pre) {
	JsMain.cnx.resolve("Recorder").resolve("startRecording").call([page, pre]);
}
JsMain.stop = function() {
	JsMain.cnx.resolve("Recorder").resolve("stopRecording").call([]);
}
JsMain.getRecordingTime = function() {
    return JsMain.cnx.resolve("Recorder").resolve("getRecordingTime").call([]);
}
